...
export default function JourneyPreview({
	...
	return (
		<div>
			...
			{/* summary card — click anywhere to expand/collapse the full map below */}
			<button
				type='button'
				onClick={() => setOpen(!open)}
				className='block w-full text-left bg-white/5 hover:bg-white/10 border border-white/10 rounded p-5 transition-colors'
			>
			...
			{/* full journey, expanded inline */}
			{open && (
				<div className='mt-4 border border-white/10 rounded p-5'>
